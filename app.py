...
<div class="app-header">
    ...
    <div class="app-subtitle">
        ...
        *****Disclaimer:  Developed for EQPOWER as a proof of concept ;Not for production.*****
    </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown(
    ...
    'This application provides conceptual weight estimates based on machine learning models trained on '
    'historical engineering data. The predicted values are intended solely for preliminary engineering '
    'studies, budgetary costing, logistics planning, proposal preparation, and procurement estimation.'
    '</div>'
    unsafe_allow_html=True,
)
